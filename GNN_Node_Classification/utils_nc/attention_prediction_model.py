...
class MultiHeadAttentionLayer(nn.Module):
    def __init__(self, num_heads, graph_size, dropout):
        ...
        self.feature_Q = GraphConv(in_feats=graph_size, out_feats=graph_size)
        self.feature_K = GraphConv(in_feats=graph_size, out_feats=graph_size)
        self.feature_V = GraphConv(in_feats=graph_size, out_feats=graph_size)
