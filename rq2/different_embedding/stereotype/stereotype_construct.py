...
step_1 = ['FACTORY-LOCAL_CONTROLLER', 'LAZY_CLASS', 'FIELD', 'FACTORY', 'FACTORY-COLLABORATOR',
          'CONSTRUCTOR-CONTROLLER', 'COMMAND-COLLABORATOR', 'VOID_ACCESSOR-COLLABORATOR', 'LOCAL_CONTROLLER',
          'COMMAND-LOCAL_CONTROLLER', 'CONSTRUCTOR-LOCAL_CONTROLLER', 'GET', 'BOUNDARY-DATA_PROVIDER', 'DATA_PROVIDER',
          'BOUNDARY', 'ABSTRACT', 'NON_VOID_COMMAND-COLLABORATOR', 'ENTITY', 'PROPERTY', 'EMPTY', 'CONTROLLER',
          'BOUNDARY-COMMANDER', 'PREDICATE', 'SET-COLLABORATOR', 'PREDICATE-COLLABORATOR', 'DATA_CLASS', 'OTHER',
          'INCIDENTAL', 'GET-COLLABORATOR', 'CONSTRUCTOR', 'PROPERTY-LOCAL_CONTROLLER', 'COMMANDER',
          'PREDICATE-LOCAL_CONTROLLER', 'MINIMAL_ENTITY', 'PROPERTY-COLLABORATOR', 'SET-LOCAL_CONTROLLER',
          'CONSTRUCTOR-COLLABORATOR', 'INTERFACE', 'GET-LOCAL_CONTROLLER', 'COLLABORATOR',
          'NON_VOID_COMMAND-LOCAL_CONTROLLER', 'NOTFOUND', 'NON_VOID_COMMAND', 'POOL', 'SET', 'DEGENERATE', 'COMMAND']
