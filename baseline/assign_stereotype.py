...
# ['ENTITY', 'SET', 'DATA_PROVIDER', 'NON_VOID_COMMAND-COLLABORATOR', 'SET-LOCAL_CONTROLLER',
#  'CONSTRUCTOR-LOCAL_CONTROLLER', 'INCIDENTAL', 'FACTORY-COLLABORATOR', 'POOL', 'FIELD', 'GET', 'CONTROLLER', 'OTHER',
#  'VOID_ACCESSOR-COLLABORATOR', 'FACTORY-CONTROLLER', 'PROPERTY-LOCAL_CONTROLLER', 'EMPTY', 'CONSTRUCTOR-COLLABORATOR',
#  'CONSTRUCTOR', 'BOUNDARY', 'NOTFOUND', 'PROPERTY', 'CONSTRUCTOR-CONTROLLER', 'NON_VOID_COMMAND',
#  'GET-LOCAL_CONTROLLER', 'INTERFACE', 'SET-COLLABORATOR', 'PREDICATE', 'GET-COLLABORATOR', 'PREDICATE-COLLABORATOR',
#  'COLLABORATOR', 'LAZY_CLASS', 'FACTORY', 'COMMANDER', 'DEGENERATE', 'MINIMAL_ENTITY', 'COMMAND-LOCAL_CONTROLLER',
#  'PROPERTY-COLLABORATOR', 'DATA_CLASS', 'BOUNDARY-DATA_PROVIDER', 'ABSTRACT', 'COMMAND', 'LOCAL_CONTROLLER',
#  'NON_VOID_COMMAND-LOCAL_CONTROLLER', 'BOUNDARY-COMMANDER', 'PREDICATE-LOCAL_CONTROLLER', 'COMMAND-COLLABORATOR',
#  'FACTORY-LOCAL_CONTROLLER']
# 48
