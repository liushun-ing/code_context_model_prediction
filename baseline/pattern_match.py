...
def graph_match(step, patterns):
    ...
    for G1 in G1s:
        # if G1s.index(G1) in [2557, 2558, 2559, 2560, 2561, 2562, 2563, 2564, 2565, 2566, 2567, 2568, 2569]:
        #     continue
...
def graph_build_and_gspan(min_sup, project_model_name='my_mylyn'):
    ...
    min_support = math.ceil(min_sup * (graph_index - 1))  # 0.02 * num_of_graphs
...
if __name__ == '__main__':
    ...
    graph_match(step=1, patterns=f'./whole_patterns/sup-{min_sup}')
