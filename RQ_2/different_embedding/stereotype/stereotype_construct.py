...
step_1 = ['GET-LOCAL_CONTROLLER', 'COMMANDER', 'CONTROLLER', 'PREDICATE-LOCAL_CONTROLLER', 'ABSTRACT', 'SET',
          'LAZY_CLASS', 'GET', 'COMMAND-COLLABORATOR', 'CONSTRUCTOR-COLLABORATOR', 'SET-LOCAL_CONTROLLER',
          'CONSTRUCTOR-CONTROLLER', 'FACTORY', 'PROPERTY', 'COMMAND-LOCAL_CONTROLLER', 'DEGENERATE',
          'PROPERTY-LOCAL_CONTROLLER', 'FIELD', 'COMMAND', 'COLLABORATOR', 'MINIMAL_ENTITY', 'CONSTRUCTOR',
          'FACTORY-COLLABORATOR', 'POOL', 'PROPERTY-COLLABORATOR', 'PREDICATE-COLLABORATOR', 'NOTFOUND',
          'NON_VOID_COMMAND-LOCAL_CONTROLLER', 'LOCAL_CONTROLLER', 'BOUNDARY', 'GET-COLLABORATOR',
          'NON_VOID_COMMAND-COLLABORATOR', 'DATA_PROVIDER', 'SET-COLLABORATOR', 'BOUNDARY-COMMANDER', 'INCIDENTAL',
          'VOID_ACCESSOR-COLLABORATOR', 'PREDICATE', 'CONSTRUCTOR-LOCAL_CONTROLLER', 'EMPTY', 'OTHER',
          'BOUNDARY-DATA_PROVIDER', 'INTERFACE', 'DATA_CLASS', 'ENTITY', 'FACTORY-LOCAL_CONTROLLER', 'NON_VOID_COMMAND']
