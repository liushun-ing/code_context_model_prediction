...
Declarations = ['MethodDeclaration', 'ConstructorDeclaration', 'FieldDeclaration', 'ConstantDeclaration']
...
class BlockNode(object):
    ...
    def add_children(self):
        ...
        elif self.token in Declarations:
...
class FieldNode(ASTNode):
    ...
    def get_token(self, lower=True):
        return self.node.declarators[0].name.lower()
